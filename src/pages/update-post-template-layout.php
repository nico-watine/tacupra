...
<article>
	<div class="row">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/wXh51Wo.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="red-container" style="padding: 30px 0; margin-bottom: 30px; background: #BB3938;">
		<div class="row">
			<div class="large-8 large-push-2 columns end">
				<img src="http://i.imgur.com/2idX8KI.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/rq8U3EF.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Upper ball joints pressed out of the spindle. </p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/FBWi942.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Some encouragement after pressing in the Camburg Upper arm spintle adapters.</p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/KX48uLp.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/XJ872rX.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/S9FdPh8.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Mocking up the Camburg upper control arms. </p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/kPPrd3F.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Close shot of the mock-up.</p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/bnzwzTW.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Cleaning the metal on the spindle for the Total Chaos spindle gusset. </p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/3B9fH8r.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>First time welding Mig uphill. <br>
			See settings here: <a href="http://imgur.com/9z3M5AR">http://imgur.com/9z3M5AR</a> <br>
			I was running a generous amount of 75/25 Argon CO2</p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/hLk01as.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
			<p>Prepping for paint.</p>
		</div>
	</div>
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/XfO1qIk.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/Zn2s1XG.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/lUZomrF.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
	...
	<div class="row" style="margin-bottom: 30px;">
		<div class="large-8 large-push-2 columns end">
			<img src="http://i.imgur.com/H1kW5sv.jpg" style="border: 3px solid #FFFFFF; box-shadow: 0 1px 4px 0 rgba(0,0,0,0.37); margin-bottom: 20px;" alt="">
